...
var SSS = {};
(function initialize() {
    SSS.panel = require("sdk/panel").Panel({
        position: {
            right: 0,
            bottom: 0
        },
    ...
    // Widget
    SSS.Widget = require("sdk/widget").Widget({
...
function getItemNodeForWidget(widget) {
    var item;
    for (var win in require("sdk/deprecated/window-utils").windowIterator()) {
...
//    twitter.getTwitterJSON(targetURL, function (err, doc) {
//        if (err) {
...
//            "title": "Twitter",
//            "url": "https://twitter.com/search/realtime?q=" + doc["query"],
//            "count": hasResJSON ? doc["results"].length : 0,
//            "comments": twitter.format(doc, {
//                ignoreNoComment: true,
//                ignoreReTweet: true
//            })
//        };
