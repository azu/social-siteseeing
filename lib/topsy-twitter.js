 ...
 */
//100までとりあえず取得
var apiEndPoint = 'http://otter.topsy.com/trackbacks.json?perpage=15&url=';
var APIKey;
...
function getTopsyJSON(target, callback){
    if (!APIKey){
        callback(new Error("require setting Topsy's API key"));
        return;
    }
    var apiURL = apiEndPoint + encodeURIComponent(target) + "&apikey=" + APIKey;
